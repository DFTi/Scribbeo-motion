...
- (void)setToggleButton:(UIButton *)newToggleButton
{
    if (newToggleButton) 
    {
        ...
        CGRect newFrame = toggleButton.frame;
        //EWW clean it up!
...
- (void)layoutSubviews
{
    ...
    CGFloat xPercent = (xWeight + 1.f) * 0.5f;
    CGFloat yPercent = (yWeight + 1.f) * 0.5f;
    ...
    for (UIView* view in self.subviews) {
        ...
        CGFloat xOffset = toggleButton.center.x + (xPercent * (toggleFrame.size.width * 0.5f));
